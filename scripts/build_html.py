...
사용법:
    python scripts/build_html.py --year 2026
    python scripts/build_html.py --year 2026 --out "(2026) 건설업시공능력평가 조회_v5.html"

--out 생략 시 파일명은 "(<year>) 건설업시공능력평가 조회_v5.html" (탭 제목과 동일).
...
def main():
    ...
    args = ap.parse_args()
    out_name = args.out or f"({args.year}) 건설업시공능력평가 조회_v5.html"
